...
public class DistributedChiSquareComputer implements Serializable, FlatMapFunction<Iterator<Tuple2<Integer,Tuple2<Double,Block>>>, ChisquareUnit> {

	public Iterable<ChisquareUnit> call(Iterator<Tuple2<Integer, Tuple2<Double, Block>>> t) throws Exception {
